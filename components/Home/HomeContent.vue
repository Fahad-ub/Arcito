    ...
    <div class="inner-wrapper">
      <div class="row">
        <p class="body">
          ...
          clients to understand their vision and bring it to life.Environmental
          stewardship is at the heart of our designs, integrating sustainable
          practices to minimize our ecological footprint.
        </p>
        <parallax-site-image src="/images/Home/home-1.webp" />
      </div>
      <div class="row parallax">
        <p class="body">
          From concept to completion, we uphold the highest standards of
          craftsmanship, ensuring every detail is meticulously executed.
        </p>
        <parallax-site-image class="parallax" src="/images/Home/home-2.webp" />
      </div>
      <div class="row">
        <div class="copy">
          <h2 class="heading-2">
